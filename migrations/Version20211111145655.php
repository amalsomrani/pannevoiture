 ...
 */
final class Version20211111145655 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE mecancien DROP FOREIGN KEY FK_50CFE4D6A76ED395');
        $this->addSql('ALTER TABLE remorquage DROP FOREIGN KEY FK_B11A8CE5A76ED395');
